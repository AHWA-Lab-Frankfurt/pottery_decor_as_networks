...
* [Submit a post for your issue](https://github.com/AHWA-Lab-Frankfurt/Mali.decor.networks/issues/), assuming one does not already exist.
...
* [Fork](https://github.com/AHWA-Lab-Frankfurt/Mali.decor.networks/#fork-destination-box) the repository on GitHub to make a copy of the repository on your account. Or use this line in your shell terminal:

    `git clone git@github.com:your-username/Mali.decor.networks.git`
...
* If you need help or unsure about anything, post an update to [your issue](https://github.com/AHWA-Lab-Frankfurt/Mali.decor.networks/issues/).

## Submitting your changes

Push to your fork and [submit a pull request](https://github.com/AHWA-Lab-Frankfurt/Mali.decor.networks/compare/).
...
* Engage in discussion on [your issue](https://github.com/AHWA-Lab-Frankfurt/Mali.decor.networks/issues/).
