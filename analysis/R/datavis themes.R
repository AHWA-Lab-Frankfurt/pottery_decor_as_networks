...
#1. publication theme for ggplot (from the envalysis package, author: Zacharias Steinmetz)
...
# 2. Parameters for network graph coloured by edge type
...
# 3. Parameters for plotting graph communities

# edge parameters
edges_community <- list(geom_edge_fan(color = "gray", aes(edge_alpha = weight, edge_width = weight)),
