...
ggplot(centrali) +
  boxplot(aes(x = community, y = div, fill = community)) +
  scale_fill_grey(start = 0.5, end  = 1) +
  theme_bw() +
  theme(legend.position = "none") +
  labs(y = "degree centrality",
...
# extract backbone
early_flat_bb <- 
  backbone::disparity(as.igraph(early_flat), alpha = 0.22, narrative = TRUE) |>
