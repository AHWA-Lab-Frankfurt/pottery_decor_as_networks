...
The pottery samples vary strongly in size. This might effect the number of decorations present and might lead to (especially rare) decoration techniques beeing absent in some sites due to the small amount of sherds excavated.
We use the iNext-package (Hsieh et al. 2016) to estimate the effect the sample size has on the diversity of the sample. This way we can decide how the different abundance of sherds might impact our network.
=======
>>>>>>> e2dc34cb43304066eb7de459929385318ee33e03
...
d <- i$iNextEst$size_based |> 
slice(c(seq(1, n(), by = 10),seq(20, n(), by = 40))) |> 
  arrange(Assemblage, m) 
...
# getting a table of the results of the analysis
e <- iNEXT(decors_abs, q=0, datatype="abundance") 

e <- e$iNextEst$size_based |> 
slice(c(seq(1, n(), by = 10),seq(20, n(), by = 40))) |> 
  arrange(Assemblage, m) 

e
#creating datatable of both periods
#rbind(d,e) |> 
 # mutate(across(where(is.numeric), ~ round(.x, 4))) |> 
  #write.csv2(here::here("analysis/data/derived_data/inext.csv"))
